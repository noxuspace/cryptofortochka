...
PY
  ...
  echo -e "${PURPLE}-----------------------------------------------------------------------${NC}"
  echo -e "${YELLOW}ВАЖНО:${NC} После init-arx-accs нужно вступить в ЖИВОЙ кластер (пункт 5 → 5/6) или создать свой и вступить в него (пункт 5 → 4/5/6)."
...
5)
  ...
  echo -e "${CYAN}11) Обновление ноды${NC}"
