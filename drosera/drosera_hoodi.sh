...
case $choice in
    ...
    3)
        ...
        curl -LO https://github.com/drosera-network/releases/releases/download/v1.22.0/drosera-operator-v1.22.0-x86_64-unknown-linux-gnu.tar.gz
        tar -xvf drosera-operator-v1.22.0-x86_64-unknown-linux-gnu.tar.gz
